  ...
  <div class="hl_page-creator--column">
    ...
    <div class="hl_page-creator--element">
      ...
      <div class="element-container" style="max-width: 700px; margin: 0 auto;">
        <p>
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quidem architecto quas mollitia
          voluptates iure consequuntur totam numquam quasi quaerat, iste, libero asperiores optio
          praesentium autem culpa doloremque laudantium in deleniti, corrupti eaque illo nam quae.
          Vel nesciunt, libero ipsa similique ipsum ducimus fuga magni. Voluptatum iste pariatur cum
          doloremque est.
        </p>
      </div>
    </div>
